...
class MedicalModelBenchmark:
    ...
    def _load_model(self):
        ...
        model_name = "monologg/biobert_v1.1_pubmed" if self.config.model_type == "biobert" else "emilyalsentzer/Bio_ClinicalBERT"
    ...
    def _print_result(result: BenchmarkResult):
        ...
        if "gpu_allocated_delta_mb" in result.memory_usage_mb:
            ...
            print(f"  Cached:    {result.memory_usage_mb['gpu_cached_end_mb'] - result.memory_usage_mb['gpu_cached_start_mb']:.2f} MB")
