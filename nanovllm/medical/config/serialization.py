...
class ConfigSerializer:
    ...
    def to_dict(cls, config: BaseMedicalConfig) -> Dict[str, Any]:
        ...
        medical_fields = {
            ...
            'preserve_case_for_abbreviations': getattr(config, 'preserve_case_for_abbreviations', None),
            'domain_adaptation': getattr(config, 'domain_adaptation', None),
            'domain_adaptation_lambda': getattr(config, 'domain_adaptation_lambda', None),
            ...
            'ner_confidence_threshold': getattr(config, 'ner_confidence_threshold', None),
            ...
            'entity_linking_knowledge_bases': getattr(config, 'entity_linking_knowledge_bases', None),
            'document_types': getattr(config, 'document_types', None),
            'section_headers': getattr(config, 'section_headers', None),
            'enable_uncertainty_estimation': getattr(config, 'enable_uncertainty_estimation', None),
