...
def main():
    ...
    delete_files = {
        ...
        "test_import_issues.py",
        "test_minimal_imports.py",
        "test_patched_import.py",
        "test_subprocess.py",
        "test_transformers.py",
        "test_transformers_import.py",
        "test_transformers_import_script.py",
        "test_biobert_import.py",
        "test_biobert_imports.py",
        "test_biobert_init.py",
        "test_biobert_minimal.py",
        "test_biobert_simple.py",
        "test_biobert_verbose.py",
        "test_biobert_direct.py",
        "test_biobert_directly.py",
        "test_biobert_detailed.py",
        "test_biobert_manual.py",
