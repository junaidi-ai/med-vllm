...
import copy
import json
from typing import Any, Dict, List, Mapping, Optional, Sequence, TypeVar, Union, overload
...
def to_serializable(obj: Any) -> Any:
    ...
    if isinstance(obj, type) and issubclass(obj, type):
        return obj.__name__
    if hasattr(obj, 'value') and hasattr(obj, '__class__') and hasattr(obj.__class__, '_member_names_'):
        return obj.value
