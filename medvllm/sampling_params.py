...
class SamplingParams:
    ...
    Attributes:
        temperature: Controls randomness in the generation. Lower values make
            the model more deterministic, while higher values increase
            randomness. Must be > 0. Defaults to 1.0.
