...
class TestMedicalConfigValidator:
    ...
    def test_validate_entity_linking_valid(self, validator: MedicalConfigValidator, config: MockConfig) -> None:
    ...
    def test_validate_entity_linking_missing_knowledge_bases(self, validator: MedicalConfigValidator) -> None:
    ...
    def test_validate_entity_linking_missing_entity_linking(self, validator: MedicalConfigValidator) -> None:
        """Test validation when entity_linking attribute is missing."""
        config = MockConfig()  # No entity_linking attribute
        # Should not raise
        validator.validate_entity_linking(config)
    
    def test_validate_medical_parameters(self, validator: MedicalConfigValidator, config: MockConfig) -> None:
        """Test validation of all medical parameters."""
        # Should not raise with valid config
        validator.validate_medical_parameters(config)
    
    def test_validate_medical_parameters_missing_attributes(self, validator: MedicalConfigValidator) -> None:
    ...
    @pytest.mark.parametrize("param_name,invalid_value,expected_error", [
        ...
        ("entity_linking", {"enabled": True, "knowledge_bases": []}, "no knowledge bases"),
    ])
    def test_validate_medical_parameters_invalid(
        self, validator: MedicalConfigValidator, param_name: str, invalid_value: Any, expected_error: str
    ) -> None:
    ...
    def test_warn_deprecated_no_alternative(self, validator: MedicalConfigValidator, recwarn) -> None:
